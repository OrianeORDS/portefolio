...
export default function DraftOptionalAnchor(props) { 
...
return (
    ...
    <Container {...ContainerProps}>
        ...
        <span className={"text-sm text-justify self-center font-source font-light"} >{props.item.text}</span>
     </Container>
...
// Composant pour ajouter un anchorTAG comme container au besoin 
