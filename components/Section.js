...
export default function Section() {
        ...
        const sectionItems = {
                quiJeSuis : [ 
                        ...
                        {icon: <ArrowListIcon/>, text:  "L’apprentissage constant qu’il implique,"},
                        {icon: <ArrowListIcon/>, text:  "La créativité qu’offre le maniement des technologies,"}, 
                        {icon: <ArrowListIcon/>, text:  "Le caractère concret et mesurable des réalisations,"},     
                ...
                mesProjets : [
                        { /* icon: <FaReact />,*/ text: "React based app using a museum API" },
                        { /* icon: <FaCode />,*/ text: "Portfolio with Next and Tailwind" },
                        { /*icon: <FaNodeJs />,*/ text: "A blog about learning Node.js" },
                        { /*icon: <FaCode />,*/  text: "Portfolio with Next and Tailwind" },
                ],
        };
